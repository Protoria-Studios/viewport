...
# window.configure(background='#7a7a7a') <-- I would like a gray background,
# but since it causes issues with transparency that I don't have the pateince
# to solve, I'll save that for another day.
...
window.bind('<e>', open_folder) # open an image
